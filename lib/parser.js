  ...
  var result = {
    ...
    parse: function(input, startRule) {
      ...
      function parse_start() {
        ...
        var result0 = [];
        var result9 = parse_Data();
        if (result9 !== null) {
          var result1 = result9;
        } else {
          var result8 = parse_DoctypeHtml5();
          if (result8 !== null) {
            var result1 = result8;
          } else {
            var result7 = parse_ProcessingInstruction();
            if (result7 !== null) {
              var result1 = result7;
            } else {
              var result6 = parse_ScriptTag();
              if (result6 !== null) {
                var result1 = result6;
              } else {
                var result5 = parse_StyleTag();
                if (result5 !== null) {
                  var result1 = result5;
                } else {
                  var result4 = parse_StartTag();
                  if (result4 !== null) {
                    var result1 = result4;
                  } else {
                    var result3 = parse_EndTag();
                    if (result3 !== null) {
                      var result1 = result3;
                    } else {
                      var result2 = parse_CDATA();
                      if (result2 !== null) {
                        var result1 = result2;
                      } else {
                        var result1 = null;;
